...
import {
  HandleError,
  HttpErrorHandler,
} from '../../../shared/_services/http-handle-error.service'
...
export class BikesService {
  ...
  voteOnBike(vote: number, bike: number): Observable<any> {
    const rating = vote
    return this.http
      .post(this.bikesUrl + `/${bike}/ratings`, { rating })
